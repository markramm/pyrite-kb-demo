---
id: the-internic-a-case-study-in-bad-database-management
title: "The InterNIC: a case study in bad database management"
type: writing
writing_type: rre-post
date: 1996-12-13
url: "http://commons.somewhere.com:80/rre/1996/The.InterNIC.a.case.stud.html"
coauthors: []
key_concepts: []
importance: 5
...
Automatically imported from: http://commons.somewhere.com:80/rre/1996/The.InterNIC.a.case.stud.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991004170239/http://www.somewhere.com/)
...
- Their automated systems do not function properly.
  ...
  indication that it might not work for any given request.- There are some data in the database which are impossible to update using
    ...
    hand.  Which brings me to my next point...- When asked how to do something that is not handled automatically by their
      ...
      response whatsoever.- There are some data in their database which are impossible to update using
