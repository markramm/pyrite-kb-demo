...
tags:
  ...
  - commerce
  - military
id: rre-database-nation
title: "[RRE]Database Nation"
type: writing
writing_type: rre-post
url: "http://commons.somewhere.com/rre/2000/RRE.Database.Nation.html"
coauthors: []
key_concepts: []
importance: 6
...
Date: Thu, 23 Dec 1999 18:11:41 -0500
...
for AIDS:- AIDS-related complex or condition (ARC) or acquired immune
    deficiency syndrome (AIDS).- Unexplained history of thrush, other opportunistic infections,
      weight loss, generalized chronic swelling of lymph nodes,
      persistent fever, or diarrhea.- Abnormal T-cell study.- Abnormal blood test for which there is no specific code.- Two or more different types of antibody tests indicating exposure
