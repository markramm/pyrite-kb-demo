...
type: writing
writing_type: paper
url: http://commons.somewhere.com:80/rre/1994/TNO.1.3.html
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1994/TNO.1.3.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991013191718/http://www.somewhere.com/)
...
* Someone wishes to subscribe to a given discussion list, so
  ...
  maintainer (probably because nobody ever told them how).* The request goes out to several hundred readers, a few of
    whom mistakenly reply to it, and these replies also go out to the
    whole list.* Whereupon several more readers send notes to the whole list
      complaining about the previous messages.* Whereupon several people wish to remove themselves from the
        discussion list, but they don't know how, so they send messages
        to the whole list.* Whereupon several more readers send out-and-out flames
...
* Complaints.  When someone does something on the net that
  ...
  network behavior.* Story-telling.  Recount stories about net behavior.  The
    ...
    the benefit of others.* Curriculum materials.  Nowadays anyone can choose from among
      ...
      helpfulness that now prevails on the net.* Network Watch.  Let's imagine an organization called Network
...
* Interface.  Many unfortunate social dynamics have their
  ...
  what the hard parts are.* Concrete instructions.  The worst set of net-user instructions
    ...
    abstractions.* FAQs.  Many folks on the net maintain lists of frequently
      ...
      a FAQ is.  (Most new users don't know what F.A.Q. stands for!)* Bounce-mail.  Bounce-mail refers to the messages you get back
        ...
        be impossible to figure out what really happened.* Collective memory.  FAQ's are a kind of collective memory.
          ...
          language of a certain discipline, etc), but it's worth a try.* Better tools for maintainers.  A lot of problems would be
