...
type: writing
writing_type: paper
url: http://commons.somewhere.com:80/rre/1994/TNO.1.11.html
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1994/TNO.1.11.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991013175322/http://www.somewhere.com/)
...
---
  ...
  Network".  (See TNO 1(1).)  To retrieve a copy, send a message
...
---
  ...
  smart papers about economic aspects of technology by someone who
  has chosen to lay aside the shiny idealizations of neoclassical
  economic theory in favor of detailed qualitative investigations
  of particular technological industries.  He points to numerous
  important phenomena, such as the large amount of interlocking,
  ...
  Ferron, Driver (Earthbeat).  Passing forty and settled down now,
  Canadian folksinger Ferron has produced a moving meditation on
  autumnal themes of deep relationship, deep wisdom, the approach
  of death, and the warmth of reconciliation.  The road has led
  here, says her gently enveloping poetry, and all has been as it
  has had to be.  I hope I hit forty that way.

  Bruce Springsteen, Tunnel of Love (Columbia).  The other evening,
  my CD player having migrated to my office, I put this relatively
  obscure 1987 Springsteen record on the turntable and was struck
  by something that had largely gotten past me back in 1987 --
  its remarkable integrity as a representation of men's lives, or
  at least of the lives of so many men I've known.  The simple and
  straightforward songs on this record cut through the machismo to
  find some real and heavy things: the burdens of responsibility,
  the exhaustion of never measuring up to impossible standards, a
  nameless grief rooted in the sadness and silence of fathers, a
  frustrating determination to break down the barriers to emotional
  intimacy, and a frightening and almost desperate faith in the
...
---
  ...
  Dentsu is a globally integrated advertising and public relations
  firm.  Founded in Japan and based in Tokyo, it now has alliances
  and subsidiaries throughout the world.  Its principal strength is
  its ability to conduct globally coordinated campaigns, primarily
  for marketing purposes, using both advertising and PR.  They make
  advertisements for laundry detergent in Australia, soccer in the
  United States, beer in Britain, sanitary napkins in Indonesia,
  and just about everything in the rest of East Asia.  Their
  investment in long-term market research on emerging markets and
  young people allows them to exert a vast, quiet influence over
  the themes and strategies to be found in the marketing campaigns
  and PR-driven news reports of the future.  Call up their Tokyo
  HQ, or their local subsidiary in your own country (just call
  directory assistance in your capital city, or New York City if
  all else fails, and ask for Dentsu), and try to get ahold of
  their annual report.  It took me four tries.
...
---
  ...
  Lydia D. Morris, Responses to redundancy: Labour-market
  experience, domestic organisation and male social networks,
  International Journal of Social Economics 12(2), 1985, pages
  5-16.

  Abstract: An in-depth study was conducted in the summer of 1982
  of the labor-market experience and domestic circumstances of 40
  redundant steelworkers and their families in Port Talbot, Wales.
  Analysis indicates that the local effects of the recession,
  combined with differential access to information about employment
  opportunities, have produced distinctive patterns of local
  labor-market experience and shifted a sector of the skilled
  workforce, accustomed to secure employment, into a pattern of
  temporary or insecure employment under poor working conditions.
  In addition, the traditional attitudes toward the sexual division
  of labor were found among men with highly developed social
  networks.  A highly developed network of contacts, based on
  male social activity revolving around local social institutions,
  cannot only act as a source of pressure that mitigates against
  the renegotiation of gender roles, but can also become: 1. a
  source of job information, 2. a means of exerting influence in
  the acquisition of employment, and 3. a vehicle for access to
  opportunities for informal economic activity.

  This abstract comes from the ABI database of the University of
  California's clunky but indispensable Melvyl system.
...
---
  ...
  The written version of Karen Coyle's talk at the 1994 CPSR Annual
  Meeting, mentioned at the beginning of my article, can now be
  retrieved by sending a message that looks like this:

    To: rre-request@weber.ucsd.edu
    Subject: archive send coyle
  ...
  I've saved some files containing descriptions of the first
  several bills that the Republicans promise to offer in the next
  Congress.  Check 'em out.  To retrieve them, send messages that
  look like this:

    To: rre-request@weber.ucsd.edu
    Subject: archive send republicans-1

  The files are called republicans-1 ... republicans-9.
  ...
  Environments.  See their announcement at URL
