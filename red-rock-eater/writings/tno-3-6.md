...
date: 1996-10-15
url: http://commons.somewhere.com:80/rre/1996/TNO.3.6.html
coauthors: []
key_concepts: []
importance: 5
...
Automatically imported from: http://commons.somewhere.com:80/rre/1996/TNO.3.6.html

## Content

|  |  |
| --- | --- |
| [**Red Rock Eater Digest**](https://web.archive.org/web/20010121144600/http://commons.somewhere.com/rre/) | **Most Recent Article: Fri, 19 Jan 2001** |
...
---
  ...
  moritorium on discussions that treat this thing, "the Internet",
...
---
  ...
  If you're looking for shadows, you can certainly find them:
    ...
    that people who agree with its political positions are not good
    Christians, he replies with the non sequitur that the Coalition
    regards its positions as justified on non-religious grounds as
    well.
...
in potential subscribers' minds, based on bad experiences they've
  ...
  only good stuff to the list.  Second they want a limited number
  of messages, so must promise not to send too many -- ten messages
...
* Do not ever give out your mailing list to others.  This is

probably obvious, but I'll say it anyway.  If you are using
...
to your list without permission, and you're located in a country
  ...
  copyrighted, and get permission before you forward them.  (Then
  say "forwarded with permission".)  The lack of a copyright notice
...
---
  ...
  society's citation format to dispaly all of my publications
...
---
  ...
  Web pages for at least a thousand associations are indexed at
  http://www.asaenet.org/Gateway/OnlineAssocDir.html
...
|  |
| --- |
| **[ProcessTree Network](https://web.archive.org/web/20010121144600/http://www.processtree.com/?sponsor=23069)** TM  For-pay Internet distributed processing. |
| Advertising helps support hosting Red Rock Eater Digest @ The Commons. Advertisers are not associated with the list owner. If you have any comments about the advertising, please direct them to the [Webmaster @ The Commons](https://web.archive.org/web/20010121144600/mailto:webmaster@somewhere.com). |