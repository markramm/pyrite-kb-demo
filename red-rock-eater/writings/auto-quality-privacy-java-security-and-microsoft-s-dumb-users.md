---
id: auto-quality-privacy-java-security-and-microsoft-s-dumb-users
title: auto quality privacy, Java security, and Microsoft's dumb users
type: writing
writing_type: rre-post
date: 1995-10-31
url: http://commons.somewhere.com:80/rre/1995/auto.quality.privacy.Jav.html
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1995/auto.quality.privacy.Jav.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991023010125/http://www.somewhere.com/)

  

# auto quality privacy, Java security, and Microsoft's dumb users

```
[This issue of Risks contains so much good stuff that I'm sending out the
whole thing.  Note especially the first message about electronic Big Brother
up your tailpipe in California.  Over the next few years I think a lot of your
possessions are going to become wired into the Matrix, and it's time to set
some good precedents about how this happens -- and when it shouldn't happen.]

Date: Tue, 31 Oct 95 15:18:55 PST
From: RISKS List Owner <risko@csla.csl.sri.com>
...
Let's assume that we have two people with such autoresponders (and
...
not bugs in the Java language itself, nor do they apply to Netscape 2.0
