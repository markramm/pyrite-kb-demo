...
writing_type: paper
date: 1999-07-30
url: "https://pages.gseis.ucla.edu/faculty/agre/zine.html"
coauthors: []
key_concepts: []
importance: 5
...
Automatically imported from: https://pages.gseis.ucla.edu/faculty/agre/zine.html

## Content

### Find Your Voice: Writing for a Webzine

#### Philip E. Agre Department of Information Studies University of California, Los Angeles Los Angeles, California 90095-1520 USA pagre@ucla.edu [http://polaris.gseis.ucla.edu/pagre/](https://web.archive.org/web/20200210084525/http://polaris.gseis.ucla.edu/pagre/) Paper presented at [Webzine'99](https://web.archive.org/web/20200210084525/http://www.webzine99.com/). This is a draft. Please do not quote from it. Version of 30 July 1999. 2300 words.
...
the machinery and tried to use it, appropriating elements of mass culture for
their own uses (Jenkins 1992), and trying to stay a step ahead of it. The
zine movement represents another strategy: creating a community of cultural
producers who talk to one another through their creative work and personal
letters without aiming for broad commercial appeal. Heartening though it is
in its goals, however, in practice this community has been defined much more
by what it is against, commercial culture, than by the positive alternatives
it is for (Duncombe 1997).

Paper-based zines have been limited by the limitations of the medium.
The Internet, however, promises a new world of popular cultural production
-- webzines. It is now less necessary to focus on negating mass culture.
Instead, it is time to reclaim the public sphere by creating a public
space outside the machines of advertising and the media. That project
has many facets: teaching and learning technical skills, plugging in the
...
level it is fueled by musicians' fervent desire to circumvent record companies
and their onerous contracts. Record companies do roughly three things:
production, distribution, and promotion. Production can already be bought by
the yard, and MP3 promises a new distribution system. That leaves the most
complicated of a record company's functions, promoting records. Recording
contracts are onerous because promotion cannot be bought by the yard:
promoting a band requires all kinds of intangible and subjective strategies
that cannot be easily specified ahead of time. The standard recording
contract is one-sided precisely to give the record company an incentive
to promote the band. When negotiating a contract with a record company,
therefore, a band's only real negotiating leverage is an established audience.
Whereas a band that has already built an audience is effectively contracting
for production and distribution, which are commodities, a band with no
existing audience can only sign the form contract and hope that the label
will invest its promotion dollars in them and not someone else. In order
to circumvent record companies completely, it follows that bands must learn
to use the Internet to promote themselves -- that is, to build an audience.
...
* Forage for fragments of voices -- phrases and ideas that seem useful.* Choose someone you identify with and copy their voice -- not their exact
    words but their style -- until you get comfortable.* Start with safer groups, or groups that you aren't afraid of.* Contribute to public discussions by responding to others, rather than by
        initiating your own topics. Responding is easier.* Let yourself make mistakes. Laugh at paranoia.* When someone misunderstands what you wrote, tell yourself that it doesn't
...
What the Internet mostly does is connect people who have something in common.
Take the case of people with cancer. In the old days, if you had cancer
then you were all alone. It was you and the medical establishment. Today,
however, if you get cancer then you get an account on an ISP and join a
community of people who have experience with the situation. And the same
...
each of these groups a community of practice (Agre 1988, Lave and Wenger 1991,
Wenger 1998). Every community of practice has its collective identity and
its ways of thinking together: rumors, associations, griots, newsletters, and
so on. And the Internet is here to amplify this effect. Some communities
have strong mechanisms for this kind of collective thinking, and others have
weak ones. Our job is to strengthen them.
...
that you haven't found your community yet. Although you are surely unique
in many ways, you are also human, and you are a product of places and times.
...
has your audience. It should be real and spontaneous, so that it's your voice
and not someone else's. Notice the tension between this rule and the strategy
of copying someone else's voice for a while.

(3) Have a point. Know what it is.

(4) Talk about current events. If attention in your community is focused on a
breaking news story or an ongoing controversy, use that issue as the point of
departure for your reflections. That's what pundits do.
...
public service by learning how to explain your values to people who don't yet
share them, thereby developing a public voice, and then sharing your voice
with others.
...
talking to the healthy parts of the person without pushing the buttons of the
other parts. If your audience has developed antibodies against a certain word
or phrase, find some other word or phrase.

(7) Don't flame. Ranting is okay, but not flaming. The difference is that
ranting communicates a coherent and original argument, whereas flaming is pure
redundant negativity. If you do rant, be sensible most of the time.
...
one by one your audience will drop you simple notes to say how much they like
your work. One by one your audience will drop you simple notes to say that
...
Persons, Chicago: University of Chicago Press, 1982.
...
Gianturco, Ithaca: Cornell University Press, 1990. Originally published
in 1709.
