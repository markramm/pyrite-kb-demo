---
id: fc-helsingius-shuts-down-anon-penet-fi-server-in-finland
title: "FC: Helsingius shuts down anon.penet.fi server in Finland"
type: writing
writing_type: rre-post
url: "http://commons.somewhere.com:80/rre/1996/FC.Helsingius.shuts.down.html"
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1996/FC.Helsingius.shuts.down.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991008064609/http://www.somewhere.com/)
...
=46rom: Azeem Azhar <azeem@dial.pipex.com>
...
The idea of an anonymous remailer is to protect the confidentiality of it=ED=
s
users=ED identity. The remailer itself does not store messages but serves as=
 a
channel for message transmission. The remailer forwards messages
without the identity of the original sender.

=46inland is one of the leading countries in Internet usage. Therefore all
...
Last Sunday=A5s issue of the English newspaper Observer claimed that the
remailer has been used for transmitting child pornography pictures. The
claims have been investigated by the Finnish police. Observer=A5s claims
...
network=A5s practical operation methods and the misuse of the network. I
