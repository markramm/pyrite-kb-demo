...
writing_type: paper
date: 1994-07-08
url: http://commons.somewhere.com:80/rre/1994/TNO.1.8.html
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1994/TNO.1.8.html

## Content

|  |  |
| --- | --- |
| [**Red Rock Eater Digest**](https://web.archive.org/web/20010914182349/http://commons.somewhere.com/rre/) | **Most Recent Article: Fri, 14 Sep 2001** |
...
---
  ...
  journalism, museum curatorship, as well as computer people)
  ...
  skills, collections, and tools that you'll need to become a
  technology activist and do good deeds for democratic uses of
  technology on Monday morning.
...
---
  ...
  the following: From VTR to Cyberspace:...The Electronic
  Commons (Mark Surman); Technical Choices for Networked
  Community Activities (Ian Duncan): The Digital City _(Kees
  Schalken/Pieter Tops); and E-Connections: Investigating E-Mail
  for Ontario Non- Profits (L. Shade); conference agendas;
...
---
  ...
  the American Working Class, London: Verso, 1991.  A brilliant and
  absorbing history of "whiteness" as a shifting category in the
  nineteenth century United States.  It was not always clear, for
  example, whether the Irish were "white".  As white working people
  lost their autonomy in the emerging industrial system, they could
  at least console themselves with the thought that at least they
...
---
  ...
  Carol S. Saunders, Daniel Robey, and Kelly A. Vaverek, The
  persistence of status differentials in computer conferencing,
  Human Communication Research 20(4), 1994, pages 443-472.

  One feature of electronic communication media is its potential
  to remove the effects of occupational role identity.  For better
  or for worse, electronic communication technologies may reduce
  occupational status differentials and allow individuals to
  communicate as equals.  This article reports results from a
  study of health-care professionals engaged in an educational
  program using computer conferences over a five-month period.
  Results show that the content and network of communication
  among health-care professionals using the computer conference
  were significantly related to occupational roles.  Specifically,
  physicians and hospital administrators were afforded higher
  status in computer conferences than nurses.  The effects of
  occupational status differentials were manifest and became
  more established with greater use of the computer conferencing
  system.  Status characteristics derived from the educational task
  also appeared to affect communication patterns.  The importance
  of considering multiple social contexts when implementing
  information technology is discussed.
...
---
  ...
  The files from the Red Rock Eater Archives (which currently
  number about 140) are now available on weber.ucsd.edu's gopher
  server.  The URL is gopher://weber.ucsd.edu/11/rre.
