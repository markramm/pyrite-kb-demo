...
date: 1996-11-13
url: http://commons.somewhere.com:80/rre/1996/spam.ruling.html
coauthors: []
key_concepts: []
importance: 5
...
Automatically imported from: http://commons.somewhere.com:80/rre/1996/spam.ruling.html

## Content

|  |  |
| --- | --- |
| [**Red Rock Eater Digest**](https://web.archive.org/web/20010520020420/http://commons.somewhere.com/rre/) | **Most Recent Article: Mon, 14 May 2001** |

# spam ruling

```
[I've enclosed the district court ruling last week that Cyber Promotions
doesn't have a First Amendment right to spam AOL's users.  The argument is
simply that AOL is not a state actor so the First Amendment does not apply.
This may seem like a no-brainer, but the decision gets more interesting as
it goes along, drawing out the analogy between spamming AOL and distributing
political leaflets at a shopping mall.  Civil libertarians have long worried
that the privatization of public space, for example the shift from public
main streets to private shopping center walkways, threatens to narrow the
range of effective venues for politically significant free speech.  If the
Internet turns us all into couch potatoes socializing in virtual shopping
malls, will this trend be exacerbated?  Note that the court's decision does
not turn on the content of Cyber Promotions' messages or the obnoxiousness of
their sending, only on AOL's power to block them.  What if, in the long run,
the economics of the net imply that no online forum is economically viable
except with a large audience and/or commercial sponsorship, and what if each
commercial forum then finds it expedient to screen out all messages advocating
this, that, or the other political view?  We hear a lot of assertions that
this cannot happen on the Internet, but the logic of these assertions has
never been clear to me.  For example, it is often asserted that people will
necessarily have vast choice on the Internet, which is not encumbered by
the bandwidth limitations of television or the physical hauling of newspapers.
But what if choice in those media is really driven by the economics of
information and sponsorship and not by the inherent properties of the medium?
And what if those same economics are driving the Internet to be integrated
with the institutions of the existing media system?]
...
End of Computer Underground Digest #8.80
...
|  |
| --- |
| **[ProcessTree Network](https://web.archive.org/web/20010520020420/http://www.processtree.com/?sponsor=23069)** TM  For-pay Internet distributed processing. |
| Advertising helps support hosting Red Rock Eater Digest @ The Commons. Advertisers are not associated with the list owner. If you have any comments about the advertising, please direct them to the [Webmaster @ The Commons](https://web.archive.org/web/20010520020420/mailto:webmaster@somewhere.com). |