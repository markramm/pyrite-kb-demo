---
id: caller-id-outrage-from-the-fcc-time-to-act
title: caller ID outrage from the FCC -- time to act
type: writing
writing_type: rre-post
date: 1994-05-15
url: http://commons.somewhere.com:80/rre/1994/caller.ID.outrage.from.t.html
coauthors: []
key_concepts: []
importance: 5
...
Automatically imported from: http://commons.somewhere.com:80/rre/1994/caller.ID.outrage.from.t.html

## Content

|  |  |
| --- | --- |
| [**Red Rock Eater Digest**](https://web.archive.org/web/20001028004131/http://commons.somewhere.com/rre/) | **Most Recent Article: Wed, 25 Oct 2000** |

# caller ID outrage from the FCC -- time to act
...
* Whether the Commission should prescribe more precise educational
  requirements.* Whether and how the policies adopted on caller ID should be extended to
...
|  |
| --- |
| **[ProcessTree Network](https://web.archive.org/web/20001028004131/http://www.processtree.com/?sponsor=23069)** TM  For-pay Internet distributed processing. |
| Advertising helps support hosting Red Rock Eater Digest @ The Commons. Advertisers are not associated with the list owner. If you have any comments about the advertising, please direct them to the [Webmaster @ The Commons](https://web.archive.org/web/20001028004131/mailto:webmaster@somewhere.com). |