...
date: 1996-05-02
url: http://commons.somewhere.com:80/rre/1996/identification.html
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1996/identification.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991009055151/http://www.somewhere.com/)
...
Excerpts from the suggestions follow:- FROM WASHINGTON, D.C.: Maryland uses Soundex (of name and birth date
  concatenated [linked in a chain]) both for driver and vehicle registrations.- FROM CAMBRIDGE, MASS.: "Against Universal Health-Care Identifiers" in the
    ...
    http://medg.lcs.mit.edu/people/psz/publications.html.- FROM YARDLEY, PA.: One way is to use a simple scheme like three letters
      ...
      for a unique string, so you might need to add some numbers.- FROM MADISON, WISC.: When I was working on the development of the
        ...
        month, and date of birth with sex and two consonants each
         extracted from the first and middle names.- FROM CYBERSPACE: I worked with a banking software company that set up
          ...
          at a time - just number them based on exact date and time added.- FROM PALO ALTO, CAL.: At Stanford University we made a decision long ago
