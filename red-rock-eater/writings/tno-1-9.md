...
type: writing
writing_type: paper
url: http://commons.somewhere.com:80/rre/1994/TNO.1.9.html
coauthors: []
key_concepts: []
importance: 6
...
Automatically imported from: http://commons.somewhere.com:80/rre/1994/TNO.1.9.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/19991014014607/http://www.somewhere.com/)
...
```
It would seem that I somehow never sent the September 1994 issue of 
The Network Observer to RRE.  So here it is.  It's also available through 
WWW at http://communication.ucsd.edu/pagre/tno-september-1994.html 
...
---
  ...
  This month: The epidemiology of Unix
              ...
              Books about writing
              The economics of job networking
...
---
  ...
  development, based on a sequence of three stages: buildling
  ...
  Iris DeMent, My Life (Warner).  With her evangelical roots sunk
  deep and her accent wholly unassimilated, Iris DeMent sings
  powerful, personal songs about family and memory and humility
  and faith.  Though I don't share all of her values, the clarity
  of her vision throws into sharp relief the homogeneity and
  abstraction of the "country" and "Christian" music that gets
  played on the radio.
...
---
  ...
  James D. Montgomery, Social networks and labor-market outcomes:
  Toward an economic analysis, American Economic Review 81(5),
  1991, pages 1408-1418.

  Abstract: Labor economists have long recognized that many workers
  find jobs through friends and relatives; personnel researchers
  argue that employee referrals are a useful device for screening
  job applicants.  Because the use of employee referrals is both
  widespread and purposive, social structure may play an important
  role in determining labor market outcomes.  The present analysis
  attempts to embed social structure in a stylized economic model
  of the labor market.  Since the model assumes that both workers
  and firms choose between formal and informal hiring channels,
  it offers a framework for exploring the equilibrium relationship
  among social structure, wages, and profits.  The model explains
  why workers who are well connected might fare better than poorly
  connected workers and why firms hiring through referal might
  earn higher profits.  The model further predicts that changes in
  social structure will alter the income distribution: an increase
  in the density of social ties or in social stratification by
  ability generates greater wage dispersion.

  This abstract comes from the "ABI" database of the University of
  California's clunky but nonetheless indispensable Melvyl system.
...
---
  ...
  http://robotics.eecs.berkeley.edu/~paulos/SRL/
...
* Oregon's No on 13 Campaign (formerly Save Our Communities PAC)
  is at: socpac@aol.com .* Idaho's No on 1 Coalition is at:  NoProp1ID@aol.com .* The Gay and Lesbian Victory Fund is at:  victoryf@aol.com .* Digital Queers is at:  kwickre@aol.com .* National Gay & Lesbian Task Force is at:  ngltf@aol.com .* Gay & Lesbian Alliance Against Defamation is at:
            glaadsfba@aol.com .* International Gay & Lesbian Human Rights Commission is at:
              iglhrc@agc.apc.org .
