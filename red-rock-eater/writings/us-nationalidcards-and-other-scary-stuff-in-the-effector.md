---
id: us-nationalidcards-and-other-scary-stuff-in-the-effector
title: US nationalIDcards and other scary stuff in the EFFector
type: writing
writing_type: rre-post
date: 1994-05-06
url: http://commons.somewhere.com:80/rre/1994/US.national.ID.cards.and.html?Search=id%20card%06
coauthors: []
key_concepts: []
importance: 7
...
Automatically imported from: http://commons.somewhere.com:80/rre/1994/US.national.ID.cards.and.html?Search=id%20card%06

## Content

|  |  |
| --- | --- |
| [**Red Rock Eater Digest**](https://web.archive.org/web/20040517044712/http://commons.somewhere.com/rre/) | **Most Recent Article: Tue, 4 May 2004** |
...
var base='https://web.archive.org/web/20040517044712/http://www.burstnet.com/';
var Tv=''; var Itr='';
var sz=''; var bkgd='';
var bgc=''; var rfr='';
var vr='v=1.0J';
...
<!--
ShowBurstAd('ad8070a','728','90','468x60A|728x90A','2', '', '');
// -->

**Searching for id card**  

# US national ID cards and other scary stuff in the EFFector

```
Date: Fri, 6 May 1994 20:27:22 -0400 (EDT)
...
* When sending or receiving electronic mail, U.S. Card users would be
  ...
  impostors.* Banking transactions (notably credit card purchases) that depend on
    authentication of the participants identities and an audit trail, would
    be registered in Postal Service systems.* Veterans, or for that matter college students and welfare recipients,
      could check their federal benefits using the identification data on their
      U.S. Cards.* Visitors to an emergency room would have instant access to medical
...
* Justice Louis D. Brandeis, dissenting, Olmstead_v.United States,
  277 U.S. 479 (1928)
...
* subscription to our quarterly hard copy newsletter Networks & Policy;* subscription to our biweekly electronic newsletter EFFector Online;* online bulletins that will keep you informed about the key legal,
      legislative and policy developments affecting your online communications;* an online response mechanism to make themselves heard on key issues.
