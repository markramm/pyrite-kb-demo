---
id: automatic-spam-blockers
title: automatic spam blockers
type: writing
writing_type: rre-post
date: 1997-03-27
url: http://commons.somewhere.com:80/rre/1997/automatic.spam.blockers.html
coauthors: []
key_concepts: []
importance: 5
...
Automatically imported from: http://commons.somewhere.com:80/rre/1997/automatic.spam.blockers.html

## Content

This web service brought to you by
[Somewhere.Com, LLC.](https://web.archive.org/web/20000229181913/http://www.somewhere.com/)

  

# automatic spam blockers

```
[Here are several items from Risks Digest about automatic spam blocking
programs.  If someone is looking for more creative ways to respond to
spammers, one possibility is to observe which spam messages are obviously
fraudulent (for example, messages that offer lots of money if you'll just
send in twenty bucks) and report these to law enforcement.  This is easy
to do.  Just print the message out, write a brief cover letter explaining
what it is and expressing concern that it might be fraudulent, and mail
it to the FBI (or the national police of your country), the local police,
etc.  Clearly illegal pyramid schemes belong in this category as well.
Keep in mind that thousands upon thousands of other people are out there
responding to spam in their own way.  If you simply pick your own favorite
response and keep doing it then the combined effects will add up quickly.
While we're at it, someone with technical knowledge could do a fine public
service by writing a few pages of plain English explaining how SMTP works,
where headers come from, what makes them easy to forge, and the various
remedies that have been suggested.  I'd be very pleased to circulate a
disquisition of this sort through RRE.]
...
* * Someone takes it upon himself to watch for spam in a newsgroup (or groups).* * When spam does appear, that someone posts a "NoCeM" message to
    news:alt.nocem.misc and/or news:news.admin.net-abuse.misc, PGP signed.* * Users who want to benefit from the filters have clients that, when
      ...
      message won't be shown to the user at all.* * Clients are also available to work with news servers, to NoCeM
...
Some advantages of this system are:- It thwarts malicious individuals or organizations attempting to
  systematically censor e-mail. Unless the user lists them as trusted
  cancellers, their notices will be ignored.- A 'spotcheck' mode would allow users to occasionally receive an otherwise
    cancelled e-mail, to ensure that an otherwise trusted canceller hasn't
    stepped over the line between spam-blocking and censorship.- There is no risk of some central database being compromised by spammers or
      censors.- Users receive more timely warnings of new spam, without needing to
        periodically check and download a spam-list.- The spammers have no-one to sue for freedom-of-speech violations.
          ...
          Vulis  <a href="mailto:dlv@bwalk.dm.com">Dr.Dimitri Vulis KOTM</a>
